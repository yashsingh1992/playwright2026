...
for(const data of dataset){
  ...
  test(`find out element from dynamic list ${data.username}`, async ({ browser }) => {
   ...
   // const bool = await page.locator("h3:has-text('ZARA COAT 3')").isVisible();
    ...
    await expect(page.locator(".user__name [type='text']").first()).toHaveText("yash.singh080892@gmail.com");
